...
import { scrollUp, signUpPageBgUrl } from "../../constants";
...
function SignInPage() {
  ...
  return (
    <div
      ...
      className="container mx-auto 2xl:max-w-screen-2xl min-h-screen flex justify-center items-center relative"
    >
      {/* main form */}
      ...
      >
        ...
        >
          ...
          <button type="button" onClick={() => navigate("/WristMall/SignUp")}>
